pipeline {
    ...
    environment {
        EC2_SERVER = '54.175.27.129'
        DEPLOY_USER = 'ubuntu'
        APP_DIR = '/home/ubuntu/order-service-ecommerce'
        APP_REPO_URL = 'https://github.com/donetrmteam/order-service-ecommerce.git'
        PORT_DEV = '3000'
        PORT_QA = '3001'
        PORT_MAIN = '3002'
    }
        ...
        stage('Deploy') {
            steps {
                script {
                    ...
                    withCredentials([sshUserPrivateKey(credentialsId: 'ssh-key-catru', keyFileVariable: 'SSH_KEY')]) {
                        sh """
